...
exec("tar -rvf $filename.+.tar.gz *.php", $output, $return_val);
exec("tar -rvf $filename.+.tar.gz *.css");
exec("tar -rvf $filename.+.tar.gz *.htaccess");
exec("tar -rvf $filename.+.tar.gz *.inc");
exec("tar -rvf $filename.+.tar.gz *.service");
exec("tar -rvf $filename.+.tar.gz *.txt");
exec("tar -rvf $filename.+.tar.gz *.json");
