...
<head>
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<script>
		...
		{
			window.location.assign("restriction.php");
		}
	...
	<br>
	  ...
	  BMR:
			...
			<?php
				if(!empty($_SESSION['bmr'])){
                                        ...
                                        echo "<a href='calbudget.php'>Calculate your BMR!</a><br>";
                                }
     ...
     <form>
      <div class="bg-dark mr-md-3 pt-3 px-5 pt-md-5 px-md-5 text-center overflow-hidden width: 40%">
        <div class="my-3 py-3">
          <button type="button" onclick="SetRestrictions();">Set Restrictions</button>
